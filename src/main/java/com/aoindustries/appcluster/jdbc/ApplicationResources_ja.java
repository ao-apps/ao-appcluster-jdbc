...
public final class ApplicationResources_ja extends EditableResourceBundle {
	...
	public ApplicationResources_ja() {
		super(
			...
			new File(System.getProperty("user.home")+"/maven2/ao/ao-appcluster/jdbc/src/main/resources/com/aoindustries/appcluster/jdbc/ApplicationResources_ja.properties")
		);
	}
}
